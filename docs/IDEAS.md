...
**The problem:** Learners hit a text and encounter 10+ unknown words. They can't read fluently, get discouraged, and don't absorb the text properly. Introducing key vocabulary _before_ the text — or giving access to word meanings _during_ reading — would change the experience completely.
...
The current home page is a functional category grid. It does the job but it doesn't _say_ anything. The new home page should feel like walking through a door into the Arabic world — atmospheric, elegant, and immediately communicating that this is serious Arabic learning.
...
An Arabic sentence with one word missing (shown as \_\_\_). Four word options. Pick the correct one. Can be vocabulary or grammar focused.
